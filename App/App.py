        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                #### if Work Experience/Experience then Experience level
                    ...
                    cand_level = "Fresher"
                    st.markdown(
                        '''<h4 style='text-align: left; color: #008000;'><strong>You are at Fresher level!!</strong>''',
                        unsafe_allow_html=True)
                ...
                if 'Education' or 'School' or 'College' in resume_text:
                    ...
                    st.markdown(
                        '''<h5 style='text-align: left; color: #FF0000;'>[-] Please add Education. It will give Your Qualification level to the recruiter</h4>''',
                        unsafe_allow_html=True)
                ...
                if 'EXPERIENCE' in resume_text:
                    ...
                    st.markdown(
                        '''<h5 style='text-align: left; color: #FF0000;'>[-] Please add Experience. It will help you to stand out from crowd</h4>''',
                        unsafe_allow_html=True)
                ...
                if 'INTERNSHIPS' in resume_text:
                    ...
                    st.markdown(
                        '''<h5 style='text-align: left; color: #FF0000;'>[-] Please add Internships. It will help you to stand out from crowd</h4>''',
                        unsafe_allow_html=True)
                ...
                if 'SKILLS' in resume_text:
                    ...
                    st.markdown(
                        '''<h5 style='text-align: left; color: #FF0000;'>[-] Please add Skills. It will help you a lot</h4>''',
                        unsafe_allow_html=True)
                ...
                if 'HOBBIES' in resume_text:
                    ...
                    st.markdown(
                        '''<h5 style='text-align: left; color: #FF0000;'>[-] Please add Hobbies. It will show your personality to the Recruiters and give the assurance that you are fit for this role or not.</h4>''',
                        unsafe_allow_html=True)
                ...
                if 'INTERESTS' in resume_text:
                    ...
                    st.markdown(
                        '''<h5 style='text-align: left; color: #FF0000;'>[-] Please add Interest. It will show your interest other that job.</h4>''',
                        unsafe_allow_html=True)
                ...
                if 'CERTIFICATIONS' in resume_text:
                    ...
                    st.markdown(
                        '''<h5 style='text-align: left; color: #FF0000;'>[-] Please add Certifications. It will show that you have done some specialization for the required position.</h4>''',
                        unsafe_allow_html=True)
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin':
                ...
                cursor.execute('''SELECT ID,
                                         ...
                                         act_mail,
                                         act_mob,
                                         convert(Predicted_Field using utf8), Timestamp, Name, Email_ID, resume_score, Page_no, pdf_name, convert (User_level using utf8), convert (Actual_skills using utf8), convert (Recommended_skills using utf8), convert (Recommended_courses using utf8), city, state, country, latlong, os_name_ver, host_name, dev_user
                                  from user_data''')
